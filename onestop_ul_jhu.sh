...
NTHREAD=$3
MODE=$4 # can be 1,2,3
FRAGMENT=fragments/BulkGravitonToHHTo4Q_MX-600to6000_MH-15to250_part${MODE}_fragment.py
...
# transfer: miniaod.root, miniaod_20ul.root, output.root
# cp -a ${WORKDIR}/miniaod.root /eos/cms/store/cmst3/group/vhcc/sfTuples/pnet2/miniaod_${MODE}_${SEED}.root
# cp -a ${WORKDIR}/miniaod_20ul.root /eos/cms/store/cmst3/group/vhcc/sfTuples/pnet2/miniaod_20ul_${MODE}_${SEED}.root
# cp -a ${WORKDIR}/output.root /eos/cms/store/cmst3/group/vhcc/sfTuples/pnet2out/output_${MODE}_${SEED}.root
